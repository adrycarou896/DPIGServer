...
public class ReconocimientoFacialPrueba {
    ...
    public void reconocerRostroYGuardar(Mat frame, Mat frame_gray, int cont, String userFolderPath, String userName) throws Exception{
        ...
        for (Rect rostro : rostrosLista) {
    		...
    		String srcSalida = userFolderPath+"/"+userName+"_img"+cont+".jpg";
